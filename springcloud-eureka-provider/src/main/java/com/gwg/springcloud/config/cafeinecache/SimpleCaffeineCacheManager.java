...
/**
 * SimpleCaffeineCacheManager
 */
public class SimpleCaffeineCacheManager implements CacheManager {
     ...
     */
    public SimpleCaffeineCacheManager() {
    }
     ...
     */
    public SimpleCaffeineCacheManager(String... cacheNames) {
    ...
    public void setCacheMap(ConcurrentMap<String, Cache> map) {
        if (!CollectionUtils.isEmpty(map)) {
            map.forEach((k, v) -> this.cacheMap.put(k, v));
            this.dynamic = false;
        }
    }
